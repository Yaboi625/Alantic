...
client.on("ready", () => {
    ...
    console.log(red('           ════════════════════════════════════════════════════════════════════════════════'));
    console.log("");
    client.user.setActivity({ type: "PLAYING", name: "Server Nuker" }); // Delete this if you wish.
});
    ...
    if (message.mentions.everyone === true) {
        ...
        const helpEmbed = new Discord.MessageEmbed()
            ...
            **Server Annihilation:** \`${prefix}die\` [text]
            ...
            .setFooter(`© Alantc | Prefix: ${prefix} | Author: ExlieChin#2222 | Cord: ${founder}`)
            .setColor(0x36393E)
